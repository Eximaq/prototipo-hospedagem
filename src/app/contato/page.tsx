...
import { createContactStructuredData } from "@/lib/structured-data";
...
export default function ContactPage() {
  ...
  return (
    <>
      <JsonLd id="contact-structured-data" data={createContactStructuredData()} />
          ...
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.82fr_0.62fr] lg:items-end">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/72">
                Escolha uma das casas, confira datas disponíveis e fale com o atendimento
                pelo WhatsApp.
              </p>
            </div>
