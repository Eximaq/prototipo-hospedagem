...
import { QuickAvailabilityBar } from "@/components/booking/quick-availability-bar";
...
export function PremiumHero() {
  ...
  return (
    <section
      id="inicio"
      className="section-anchor relative min-h-[82svh] overflow-hidden bg-[var(--color-ocean-strong)] text-white"
    >
      <Image
      ...
      <div className="relative z-10 mx-auto grid min-h-[82svh] max-w-7xl place-items-center px-4 py-24 text-center md:px-6 xl:px-8">
